# -*- coding: utf-8 -*- 
""" 
Created on Thu May  3 15:10:40 2023 
...
BGIMG = pygame.image.load('./C082NXuanPhucP/background.png') # hình nền 
 
# LAYER (SURFACE) NỀN 
DISPLAYSURF = pygame.display.set_mode((WINDOWWIDTH, WINDOWHEIGHT)) 
pygame.display.set_caption('stt Ho Tên = Ex5: Game = Game ĐUA XE') 
...
CARHEIGHT = 60 
CARSPEED = 3 
CARIMG = pygame.image.load('C082NXuanPhucP/car.png') 
#LỚP XE TRONG GAME 
class Car(): 
    def __init__(self): 
        self.width = CARWIDTH 
...
OBSTACLESSPEED = 2 
CHANGESPEED = 0.001 
OBSTACLESIMG = pygame.image.load('C082NXuanPhucP/obstacles.png') 
